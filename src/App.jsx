...
const RECIPES = [
  ...
  },
  {
    ...
    pantryAr: ["زبدة", "ملح وفلفل"],
    steps: [
      "Boil the potatoes and carrot until tender, then mash roughly.",
      "Shred the cabbage and sauté with the onion in butter until soft.",
      "Combine the mash with the cabbage mixture and season well.",
      "Press into a pan and fry both sides in butter until golden and crisp.",
    ],
    stepsAr: [
      "اسلقي البطاطس والجزر حتى ينضجا ثم اهرسيهما هرسًا خشنًا.",
      "قطّعي الملفوف وقلّبيه مع البصل في الزبدة حتى يلين.",
      "امزجي الهريس مع خليط الملفوف وتبّليه جيدًا.",
      "اضغطي الخليط في مقلاة واقليه من الجهتين في الزبدة حتى يذهّب ويقرمش.",
    ],
  },
  {
    ...
    steps: [
      ...
      "Add the peas and a splash of water, and simmer for 3-4 minutes.",
      "Stir through chopped fresh mint just before serving.",
      "Season with salt and pepper and serve warm.",
    ],
    stepsAr: [
      "قلّبي البصل المفروم ناعمًا في الزبدة حتى يلين.",
      "أضيفي البازلاء ورشة ماء واتركيها على النار لمدة ٣-٤ دقائق.",
      "أضيفي النعناع المفروم قبل التقديم مباشرة.",
      "تبّليها بالملح والفلفل وقدّميها دافئة.",
    ],
  },
  {
    id: "waldorf-salad",
    ...
    pantry: ["Mayonnaise", "Walnuts (optional)", "Lemon juice"],
    pantryAr: ["مايونيز", "جوز (اختياري)", "عصير ليمون"],
    steps: [
      "Dice the apple and toss with a squeeze of lemon juice to stop browning.",
      "Slice the celery thinly and halve the grapes.",
      "Combine everything with a few spoonfuls of mayonnaise until coated.",
      "Chill briefly before serving.",
    ],
    stepsAr: [
      "قطّعي التفاح مكعبات وقلّبيه مع رشة عصير ليمون لمنع اسمراره.",
      "قطّعي الكرفس شرائح رفيعة وقصّي العنب إلى نصفين.",
      "امزجي كل شيء مع بضع ملاعق من المايونيز حتى يتغطى جيدًا.",
      "برّديها قليلًا قبل التقديم.",
    ],
  },
  {
    id: "eton-mess",
    ...
    pantry: ["Whipped cream", "Meringue pieces", "Sugar, to taste"],
    pantryAr: ["كريمة مخفوقة", "قطع مرينغ", "سكر حسب الرغبة"],
    steps: [
      "Roughly chop the strawberries and lightly crush a few of the berries.",
      "Fold the mixed berries through the whipped cream.",
      "Gently break in the meringue pieces, keeping some texture.",
      "Spoon into glasses and serve immediately.",
    ],
    stepsAr: [
      "قطّعي الفراولة تقطيعًا خشنًا واسحقي القليل من التوت برفق.",
      "اطوي خليط التوت مع الكريمة المخفوقة.",
      "أضيفي قطع المرينغ برفق مع الحفاظ على بعض القوام.",
      "وزّعيها في أكواب وقدّميها فورًا.",
    ],
  },
  {
    ...
    pantry: ["Olive oil or goose fat", "Salt & pepper", "Rosemary"],
    pantryAr: ["زيت زيتون أو دهن الإوز", "ملح وفلفل", "إكليل الجبل"],
    steps: [
      "Peel and cut the potatoes, carrots, and parsnip into even chunks.",
      "Toss with oil, whole garlic cloves, salt and pepper on a roasting tray.",
      "Roast at a high heat, turning occasionally, until golden and tender.",
      "Add the halved Brussels sprouts for the last 15-20 minutes of roasting.",
    ],
    stepsAr: [
      "قشّري وقطّعي البطاطس والجزر والجزر الأبيض إلى قطع متساوية.",
      "قلّبيها مع الزيت وفصوص الثوم الكاملة والملح والفلفل في صينية الشوي.",
      "اشويها على حرارة عالية مع التقليب أحيانًا حتى تذهّب وتنضج.",
      "أضيفي كرنب بروكسل مقطّعًا إلى نصفين في آخر ١٥-٢٠ دقيقة من الشوي.",
    ],
  },
  {
    id: "apple-crumble",
    ...
    produce: ["Apple", "Lemon"],
    pantry: ["Flour", "Butter", "Sugar", "Cinnamon"],
    pantryAr: ["طحين", "زبدة", "سكر", "قرفة"],
    steps: [
      "Peel and slice the apples, tossing with a little lemon juice and sugar.",
      "Rub the flour and butter together with sugar and cinnamon until crumbly.",
      "Spread the apples in a baking dish and cover with the crumble topping.",
      "Bake until the top is golden and the apples are soft underneath.",
    ],
    stepsAr: [
      "قشّري وقطّعي التفاح إلى شرائح وقلّبيه مع القليل من عصير الليمون والسكر.",
      "افركي الطحين والزبدة مع السكر والقرفة حتى يصبح القوام متفتتًا.",
      "افرشي التفاح في طبق خبز وغطّيه بطبقة الكرامبل.",
      "اخبزيه حتى يذهّب السطح ويلين التفاح من الأسفل.",
    ],
  },
  {
    id: "okroshka",
    ...
    pantry: ["Kefir or diluted kvass", "Boiled eggs", "Sour cream", "Salt"],
    pantryAr: ["كفير أو كفاس مخفف", "بيض مسلوق", "قشدة حامضة", "ملح"],
    steps: [
      "Dice the cucumber and radish into small, even cubes.",
      "Finely chop the spring onion and dill.",
      "Combine the vegetables with chopped boiled egg in a bowl.",
      "Pour over cold kefir, stir in a spoon of sour cream, and season with salt.",
    ],
    stepsAr: [
      "قطّعي الخيار والفجل مكعبات صغيرة ومتساوية.",
      "افرمي البصل الأخضر والشبت ناعمًا.",
      "اخلطي الخضروات مع البيض المسلوق المفروم في وعاء.",
      "اسكبي الكفير البارد فوقها وأضيفي ملعقة من القشدة الحامضة وتبّليها بالملح.",
    ],
  },
  {
    id: "shchi",
    ...
    pantry: ["Beef or vegetable stock", "Bay leaf", "Sour cream, to serve", "Salt & pepper"],
    pantryAr: ["مرق لحم أو خضار", "ورق غار", "قشدة حامضة للتقديم", "ملح وفلفل"],
    steps: [
      "Sauté the diced onion and carrot until softened.",
      "Add shredded cabbage and diced potato, then pour in the stock.",
      "Simmer with a bay leaf until the vegetables are tender, about 25 minutes.",
      "Season and serve hot with a spoonful of sour cream and chopped parsley.",
    ],
    stepsAr: [
      "قلّبي البصل والجزر المفرومين حتى يلينا.",
      "أضيفي الملفوف المبشور والبطاطس المقطعة ثم اسكبي المرق.",
      "اتركيها تغلي مع ورقة الغار حتى تنضج الخضروات، حوالي ٢٥ دقيقة.",
      "تبّليها وقدّميها ساخنة مع ملعقة من القشدة الحامضة والبقدونس المفروم.",
    ],
  },
  {
    ...
    pantry: ["Mayonnaise or sour cream", "Walnuts (optional)", "Salt"],
    pantryAr: ["مايونيز أو قشدة حامضة", "جوز (اختياري)", "ملح"],
    steps: [
      "Boil or roast the beetroot until tender, then peel and grate coarsely.",
      "Crush the garlic and mix through the grated beetroot.",
      "Stir in a few spoonfuls of mayonnaise or sour cream and season with salt.",
      "Chill before serving, topped with walnuts if using.",
    ],
    stepsAr: [
      "اسلقي أو اشوي الشمندر حتى ينضج ثم قشّريه وابشريه بشرًا خشنًا.",
      "اهرسي الثوم وامزجيه مع الشمندر المبشور.",
      "أضيفي بضع ملاعق من المايونيز أو القشدة الحامضة وتبّليها بالملح.",
      "برّديها قبل التقديم وزيّنيها بالجوز إن رغبتِ.",
    ],
  },
  {
    ...
    pantry: ["Cream", "Butter", "Cheese, grated", "Salt & pepper"],
    pantryAr: ["كريمة", "زبدة", "جبنة مبشورة", "ملح وفلفل"],
    steps: [
      "Slice the mushrooms and onion, then sauté in butter until golden.",
      "Pour in cream and simmer until slightly thickened.",
      "Spoon into small baking dishes and top with grated cheese.",
      "Bake until bubbling and golden on top.",
    ],
    stepsAr: [
      "قطّعي الفطر والبصل شرائح ثم قلّبيهما في الزبدة حتى يذهّبا.",
      "أضيفي الكريمة واتركيها على النار حتى تتكاثف قليلًا.",
      "وزّعيها في أطباق خبز صغيرة وغطّيها بالجبنة المبشورة.",
      "اخبزيها حتى تفور وتذهّب من الأعلى.",
    ],
  },
  {
    ...
    pantry: ["Vinegar", "Sugar", "Salt", "Water"],
    pantryAr: ["خل", "سكر", "ملح", "ماء"],
    steps: [
      "Slice the cucumber and shred the cabbage and carrot.",
      "Pack into a jar with sliced garlic and dill.",
      "Bring vinegar, water, sugar and salt to a boil and pour over the vegetables.",
      "Let cool, then refrigerate for at least a few hours before serving.",
    ],
    stepsAr: [
      "قطّعي الخيار شرائح وابشري الملفوف والجزر.",
      "رتّبيها في برطمان مع شرائح الثوم والشبت.",
      "اغلي الخل والماء والسكر والملح واسكبيه فوق الخضروات.",
      "دعيها تبرد ثم بردّيها في الثلاجة لبضع ساعات على الأقل قبل التقديم.",
    ],
  },
  {
    id: "berry-kompot",
    ...
    pantryAr: ["سكر", "ماء"],
    steps: [
      "Combine the fruit in a large pot with water to cover.",
      "Add sugar to taste and bring to a gentle boil.",
      "Simmer for 10-15 minutes until the fruit softens and releases its flavor.",
      "Strain if desired, then chill before serving cold.",
    ],
    stepsAr: [
      "ضعي الفواكه في قدر كبير مع ماء يغطيها.",
      "أضيفي السكر حسب الرغبة واتركيها تغلي برفق.",
      "اتركيها على نار هادئة ١٠-١٥ دقيقة حتى تلين الفواكه وتطلق نكهتها.",
      "صفّيها إن رغبتِ ثم بردّيها وقدّميها باردة.",
    ],
  },
  {
    id: "aloo-gobi",
    ...
    pantry: ["Turmeric", "Cumin seeds", "Garam masala", "Vegetable oil", "Salt"],
    pantryAr: ["كركم", "بذور كمون", "جارام ماسالا", "زيت نباتي", "ملح"],
    steps: [
      "Sauté cumin seeds in oil, then add chopped onion, ginger and garlic.",
      "Add diced potato and cauliflower florets with turmeric and salt.",
      "Stir in chopped tomato, cover, and cook until the vegetables are tender.",
      "Finish with garam masala and fresh coriander before serving.",
    ],
    stepsAr: [
      "قلّبي بذور الكمون في الزيت ثم أضيفي البصل والزنجبيل والثوم المفروم.",
      "أضيفي البطاطس المقطعة وزهيرات القرنبيط مع الكركم والملح.",
      "أضيفي الطماطم المفرومة وغطّي القدر واطبخيها حتى تنضج الخضروات.",
      "أنهيها بالجارام ماسالا والكزبرة الطازجة قبل التقديم.",
    ],
  },
  {
    id: "baingan-bharta",
    ...
    pantry: ["Cumin seeds", "Turmeric", "Vegetable oil", "Salt"],
    pantryAr: ["بذور كمون", "كركم", "زيت نباتي", "ملح"],
    steps: [
      "Roast the whole eggplant over a flame or in the oven until soft and charred.",
      "Peel and mash the flesh once cool enough to handle.",
      "Sauté onion, garlic, ginger and green chili in oil with cumin and turmeric.",
      "Add the tomato and mashed eggplant, cook until combined, and finish with coriander.",
    ],
    stepsAr: [
      "اشوي الباذنجان كاملًا على النار أو في الفرن حتى يلين ويتفحم قليلًا.",
      "قشّريه واهرسي اللب بعد أن يبرد قليلًا.",
      "قلّبي البصل والثوم والزنجبيل والفلفل الأخضر في الزيت مع الكمون والكركم.",
      "أضيفي الطماطم والباذنجان المهروس واطبخيهما معًا ثم أنهيهما بالكزبرة.",
    ],
  },
  {
    id: "bhindi-masala",
    ...
    pantry: ["Cumin seeds", "Turmeric", "Coriander powder", "Vegetable oil", "Salt"],
    pantryAr: ["بذور كمون", "كركم", "كزبرة مطحونة", "زيت نباتي", "ملح"],
    steps: [
      "Wash and dry the okra thoroughly, then slice into rounds.",
      "Sauté cumin seeds, onion and garlic in oil until softened.",
      "Add the okra and spices, cooking uncovered to avoid excess moisture.",
      "Stir in chopped tomato and cook until the okra is tender, finishing with coriander.",
    ],
    stepsAr: [
      "اغسلي البامية وجفّفيها جيدًا ثم قطّعيها إلى حلقات.",
      "قلّبي بذور الكمون والبصل والثوم في الزيت حتى يلينا.",
      "أضيفي البامية والتوابل واطبخيها مكشوفة لتجنب الرطوبة الزائدة.",
      "أضيفي الطماطم المفرومة واطبخيها حتى تنضج البامية ثم أنهيها بالكزبرة.",
    ],
  },
  {
    id: "palak-paneer",
    ...
    pantry: ["Paneer cheese", "Cream", "Cumin seeds", "Garam masala", "Vegetable oil", "Salt"],
    pantryAr: ["جبنة بانير", "كريمة", "بذور كمون", "جارام ماسالا", "زيت نباتي", "ملح"],
    steps: [
      "Blanch the spinach briefly, then blend into a smooth purée.",
      "Sauté onion, garlic, ginger and green chili in oil with cumin seeds.",
      "Add the tomato and cook down, then stir in the spinach purée.",
      "Fold in cubed paneer and a splash of cream, and simmer briefly before serving.",
    ],
    stepsAr: [
      "اسلقي السبانخ سريعًا ثم اهرسيها حتى تصبح ناعمة.",
      "قلّبي البصل والثوم والزنجبيل والفلفل الأخضر في الزيت مع بذور الكمون.",
      "أضيفي الطماطم واطبخيها ثم أضيفي هريس السبانخ.",
      "أضيفي مكعبات البانير ورشة من الكريمة واتركيها على النار قليلًا قبل التقديم.",
    ],
  },
  {
    id: "cucumber-raita",
    ...
    pantry: ["Plain yogurt", "Cumin powder", "Salt"],
    pantryAr: ["لبن زبادي", "كمون مطحون", "ملح"],
    steps: [
      "Grate the cucumber and squeeze out excess water.",
      "Whisk the yogurt until smooth, then stir in the cucumber.",
      "Add finely chopped mint and coriander with a pinch of cumin and salt.",
      "Chill before serving alongside spiced dishes.",
    ],
    stepsAr: [
      "ابشري الخيار واعصريه للتخلص من الماء الزائد.",
      "اخفقي اللبن حتى يصبح ناعمًا ثم أضيفي الخيار.",
      "أضيفي النعناع والكزبرة المفرومين ناعمًا مع رشة كمون وملح.",
      "برّديها قبل تقديمها مع الأطباق الحارة.",
    ],
  },
  {
    id: "kachumber-salad",
    ...
    pantry: ["Salt", "Roasted cumin powder"],
    pantryAr: ["ملح", "كمون محمّص مطحون"],
    steps: [
      "Dice the cucumber, tomato and onion into small, even pieces.",
      "Finely chop the green chili and coriander.",
      "Toss everything together with a squeeze of lemon juice.",
      "Season with salt and a pinch of roasted cumin, then serve immediately.",
    ],
    stepsAr: [
      "قطّعي الخيار والطماطم والبصل مكعبات صغيرة ومتساوية.",
      "افرمي الفلفل الأخضر والكزبرة ناعمًا.",
      "اخلطي كل شيء مع رشة من عصير الليمون.",
      "تبّليها بالملح ورشة من الكمون المحمّص وقدّميها فورًا.",
    ],
  },
  {
    id: "mango-lassi",
    ...
    produce: ["Mango"],
    pantry: ["Plain yogurt", "Sugar or honey", "Ice cubes", "Cardamom (optional)"],
    pantryAr: ["لبن زبادي", "سكر أو عسل", "مكعبات ثلج", "هيل (اختياري)"],
    steps: [
      "Peel and chop the ripe mango.",
      "Blend the mango with yogurt, sugar, and a little water until smooth.",
      "Add ice cubes and blend again until frothy.",
      "Pour into glasses and serve immediately, chilled.",
    ],
    stepsAr: [
      "قشّري وقطّعي المانجو الناضجة.",
      "اخلطي المانجو مع اللبن والسكر وقليل من الماء حتى يصبح القوام ناعمًا.",
      "أضيفي مكعبات الثلج واخلطي مجددًا حتى يصبح رغويًا.",
      "اسكبيه في أكواب وقدّميه فورًا وهو بارد.",
    ],
  },
  {
    id: "aam-panna",
    ...
    pantry: ["Sugar", "Roasted cumin powder", "Black salt", "Water"],
    pantryAr: ["سكر", "كمون محمّص مطحون", "ملح أسود", "ماء"],
    steps: [
      "Boil the green mango until soft, then scoop out the pulp.",
      "Blend the pulp with sugar, roasted cumin, black salt and water.",
      "Add fresh mint leaves and blend briefly to combine.",
      "Strain if desired, chill, and serve over ice.",
    ],
    stepsAr: [
      "اسلقي المانجو الأخضر حتى يلين ثم استخرجي اللب.",
      "اخلطي اللب مع السكر والكمون المحمّص والملح الأسود والماء.",
      "أضيفي أوراق النعناع الطازجة واخلطيها قليلًا.",
      "صفّيها إن رغبتِ وبردّيها وقدّميها مع الثلج.",
    ],
  },
  {
    ...
    pantry: ["Protein powder", "Almond milk or water", "Ice cubes"],
    pantryAr: ["بروتين بودرة", "حليب لوز أو ماء", "مكعبات ثلج"],
    steps: [
      "Add the spinach, banana and peeled kiwi to a blender.",
      "Add a scoop of protein powder and almond milk or water.",
      "Blend until completely smooth.",
      "Pour over ice and drink immediately.",
    ],
    stepsAr: [
      "ضعي السبانخ والموز والكيوي المقشر في الخلاط.",
      "أضيفي ملعقة من البروتين بودرة وحليب اللوز أو الماء.",
      "اخلطي حتى يصبح القوام ناعمًا تمامًا.",
      "اسكبيه فوق الثلج واشربيه فورًا.",
    ],
  },
  {
    ...
    pantry: ["Protein powder or Greek yogurt", "Granola", "Chia seeds"],
    pantryAr: ["بروتين بودرة أو لبن يوناني", "غرانولا", "بذور الشيا"],
    steps: [
      "Blend the mango, banana, spinach and a splash of water until thick and smooth.",
      "Pour into a bowl — it should be thick enough to eat with a spoon.",
      "Top with sliced kiwi and blueberries.",
      "Finish with a sprinkle of granola and chia seeds.",
    ],
    stepsAr: [
      "اخلطي المانجو والموز والسبانخ ورشة ماء حتى يصبح القوام كثيفًا وناعمًا.",
      "اسكبيه في طبق — يجب أن يكون كثيفًا بما يكفي ليؤكل بالملعقة.",
      "زيّنيه بشرائح الكيوي والتوت الأزرق.",
      "أنهيه برشة من الغرانولا وبذور الشيا.",
    ],
  },
  {
    ...
    pantry: ["Rolled oats", "Greek yogurt or milk", "Chia seeds", "Honey"],
    pantryAr: ["شوفان", "لبن يوناني أو حليب", "بذور الشيا", "عسل"],
    steps: [
      "Combine the oats, yogurt or milk, and chia seeds in a jar.",
      "Stir in a drizzle of honey and slices of banana.",
      "Cover and refrigerate overnight.",
      "Top with fresh strawberries and blueberries before eating.",
    ],
    stepsAr: [
      "اخلطي الشوفان واللبن أو الحليب وبذور الشيا في برطمان.",
      "أضيفي رشة من العسل وشرائح الموز.",
      "غطّيه وبردّيه في الثلاجة طوال الليل.",
      "زيّنيه بالفراولة والتوت الأزرق الطازجين قبل الأكل.",
    ],
  },
  {
    ...
    pantry: ["Egg whites", "Olive oil", "Salt & pepper"],
    pantryAr: ["بياض بيض", "زيت زيتون", "ملح وفلفل"],
    steps: [
      "Sauté the sliced mushroom and diced tomato in a little olive oil.",
      "Add the spinach and cook until just wilted.",
      "Pour in the egg whites and scramble gently over low heat.",
      "Season with salt and pepper and serve hot.",
    ],
    stepsAr: [
      "قلّبي الفطر المقطع والطماطم المقطعة في القليل من زيت الزيتون.",
      "أضيفي السبانخ واطبخيها حتى تذبل فقط.",
      "اسكبي بياض البيض وحرّكيه برفق على نار هادئة.",
      "تبّليه بالملح والفلفل وقدّميه ساخنًا.",
    ],
  },
  {
    ...
    pantry: ["Quinoa", "Chickpeas", "Olive oil", "Lemon juice", "Salt & pepper"],
    pantryAr: ["كينوا", "حمص", "زيت زيتون", "عصير ليمون", "ملح وفلفل"],
    steps: [
      "Cook the quinoa according to package instructions and let cool slightly.",
      "Roast the broccoli, carrot and bell pepper with olive oil until tender.",
      "Assemble the quinoa in a bowl with the roasted vegetables and chickpeas.",
      "Top with sliced avocado and a squeeze of lemon juice.",
    ],
    stepsAr: [
      "اطبخي الكينوا حسب تعليمات العبوة ودعيها تبرد قليلًا.",
      "اشوي البروكلي والجزر والفلفل الحلو مع زيت الزيتون حتى ينضجوا.",
      "رتّبي الكينوا في طبق مع الخضروات المشوية والحمص.",
      "زيّنيه بشرائح الأفوكادو ورشة من عصير الليمون.",
    ],
  },
  {
    ...
    pantry: ["Grilled chicken breast", "Feta cheese", "Olives", "Olive oil", "Oregano"],
    pantryAr: ["صدر دجاج مشوي", "جبنة فيتا", "زيتون", "زيت زيتون", "أوريجانو"],
    steps: [
      "Chop the cucumber, cherry tomato, bell pepper and red onion into chunks.",
      "Slice the grilled chicken breast.",
      "Combine everything in a bowl with olives and crumbled feta.",
      "Dress with olive oil and a pinch of oregano before serving.",
    ],
    stepsAr: [
      "قطّعي الخيار والطماطم الكرزية والفلفل الحلو والبصل الأحمر إلى قطع.",
      "قطّعي صدر الدجاج المشوي شرائح.",
      "اخلطي كل شيء في وعاء مع الزيتون وجبنة الفيتا المفتتة.",
      "تبّليها بزيت الزيتون ورشة من الأوريجانو قبل التقديم.",
    ],
  },
  {
    ...
    pantry: ["Ground turkey, cooked", "Soy sauce", "Ginger", "Garlic"],
    pantryAr: ["ديك رومي مفروم ومطبوخ", "صلصة صويا", "زنجبيل", "ثوم"],
    steps: [
      "Cook the ground turkey with garlic, ginger and a splash of soy sauce.",
      "Julienne the carrot and cucumber, and slice the spring onion.",
      "Separate the lettuce into individual cup-shaped leaves.",
      "Spoon the turkey mixture into the lettuce cups and top with the vegetables.",
    ],
    stepsAr: [
      "اطبخي الديك الرومي المفروم مع الثوم والزنجبيل ورشة من صلصة الصويا.",
      "قطّعي الجزر والخيار إلى شرائح رفيعة وقطّعي البصل الأخضر.",
      "افصلي أوراق الخس إلى أكواب فردية.",
      "ضعي خليط الديك الرومي في أكواب الخس وزيّنيها بالخضروات.",
    ],
  },
  {
    ...
    pantry: ["Chickpeas", "Olive oil", "Cumin", "Paprika", "Salt & pepper"],
    pantryAr: ["حمص", "زيت زيتون", "كمون", "بابريكا", "ملح وفلفل"],
    steps: [
      "Cut the sweet potato, cauliflower and bell pepper into even pieces.",
      "Toss with the chickpeas, olive oil, cumin, paprika, salt and pepper on a tray.",
      "Roast at a high heat until the vegetables are golden and tender, about 25 minutes.",
      "Add the broccoli florets for the last 10 minutes of roasting.",
    ],
    stepsAr: [
      "قطّعي البطاطا الحلوة والقرنبيط والفلفل الحلو إلى قطع متساوية.",
      "قلّبيها مع الحمص وزيت الزيتون والكمون والبابريكا والملح والفلفل في صينية.",
      "اشويها على حرارة عالية حتى تذهّب وتنضج، حوالي ٢٥ دقيقة.",
      "أضيفي زهيرات البروكلي في آخر ١٠ دقائق من الشوي.",
    ],
  },
  {
    ...
    pantry: ["Canned tuna, drained", "Lemon juice", "Olive oil", "Salt & pepper"],
    pantryAr: ["تونة معلبة ومصفّاة", "عصير ليمون", "زيت زيتون", "ملح وفلفل"],
    steps: [
      "Chop the romaine, cucumber and cherry tomato, and slice the avocado.",
      "Flake the tuna and combine with the vegetables.",
      "Dress with lemon juice, a drizzle of olive oil, salt and pepper.",
      "Toss gently and serve immediately.",
    ],
    stepsAr: [
      "قطّعي الخس والخيار والطماطم الكرزية وشرّحي الأفوكادو.",
      "فتّتي التونة وامزجيها مع الخضروات.",
      "تبّليها بعصير الليمون ورشة من زيت الزيتون والملح والفلفل.",
      "قلّبيها برفق وقدّميها فورًا.",
    ],
  },
  {
    ...
    pantry: ["Lean steak", "Olive oil", "Salt & pepper", "Rosemary"],
    pantryAr: ["ستيك قليل الدهن", "زيت زيتون", "ملح وفلفل", "إكليل الجبل"],
    steps: [
      "Season the steak with salt, pepper and rosemary, then let it rest at room temperature.",
      "Sear the steak in a hot pan to your preferred doneness, then rest before slicing.",
      "In the same pan, sauté the asparagus and crushed garlic until just tender.",
      "Plate the sliced steak with the asparagus and halved cherry tomatoes.",
    ],
    stepsAr: [
      "تبّلي الستيك بالملح والفلفل وإكليل الجبل ودعيه في حرارة الغرفة قليلًا.",
      "اقلي الستيك في مقلاة ساخنة حتى النضج المرغوب ثم دعيه يرتاح قبل التقطيع.",
      "في نفس المقلاة، قلّبي الهليون والثوم المهروس حتى يلينا قليلًا.",
      "رتّبي الستيك المقطع مع الهليون والطماطم الكرزية المقطعة إلى نصفين.",
    ],
  },
  {
    ...
    pantry: ["Feta cheese", "Olive oil", "Balsamic glaze (optional)"],
    pantryAr: ["جبنة فيتا", "زيت زيتون", "صلصة البلسميك (اختياري)"],
    steps: [
      "Cut the watermelon into bite-sized cubes.",
      "Arrange on a plate and crumble feta cheese over the top.",
      "Scatter fresh mint leaves across the salad.",
      "Drizzle with olive oil and balsamic glaze if using, then serve chilled.",
    ],
    stepsAr: [
      "قطّعي البطيخ مكعبات صغيرة.",
      "رتّبيها في طبق ورشّي جبنة الفيتا المفتتة فوقها.",
      "وزّعي أوراق النعناع الطازجة على السلطة.",
      "أضيفي رشة من زيت الزيتون وصلصة البلسميك إن رغبتِ وقدّميها باردة.",
    ],
  },
  {
    ...
    pantry: ["Water, if needed"],
    pantryAr: ["ماء عند الحاجة"],
    steps: [
      "Roughly chop the cucumber, celery, spinach and apple.",
      "Juice everything together with a slice of lemon and a small piece of ginger.",
      "Stir well and add a splash of water if the juice is too thick.",
      "Serve immediately over ice.",
    ],
    stepsAr: [
      "قطّعي الخيار والكرفس والسبانخ والتفاح تقطيعًا خشنًا.",
      "اعصريها معًا مع شريحة ليمون وقطعة صغيرة من الزنجبيل.",
      "قلّبيه جيدًا وأضيفي رشة ماء إذا كان العصير كثيفًا جدًا.",
      "قدّميه فورًا مع الثلج.",
    ],
  },
  {
    ...
    pantry: ["Chickpeas", "Feta cheese", "Olive oil", "Lemon juice", "Salt & pepper"],
    pantryAr: ["حمص", "جبنة فيتا", "زيت زيتون", "عصير ليمون", "ملح وفلفل"],
    steps: [
      "Chop the romaine, cucumber, bell pepper and cherry tomato.",
      "Drain and rinse the chickpeas, then add to the vegetables.",
      "Crumble feta cheese over the top.",
      "Dress with olive oil, lemon juice, salt and pepper, and toss well.",
    ],
    stepsAr: [
      "قطّعي الخس والخيار والفلفل الحلو والطماطم الكرزية.",
      "صفّي واغسلي الحمص ثم أضيفيه إلى الخضروات.",
      "رشّي جبنة الفيتا المفتتة فوقها.",
      "تبّليها بزيت الزيتون وعصير الليمون والملح والفلفل وقلّبيها جيدًا.",
    ],
  },
  {
    ...
    pantry: ["Grilled chicken breast", "Quinoa or rice", "Olive oil", "Salt & pepper"],
    pantryAr: ["صدر دجاج مشوي", "كينوا أو أرز", "زيت زيتون", "ملح وفلفل"],
    steps: [
      "Cook the quinoa or rice according to package instructions.",
      "Roast the broccoli, bell pepper and zucchini with olive oil until tender.",
      "Slice the grilled chicken breast.",
      "Assemble the bowl with the grain, roasted vegetables, chicken and halved cherry tomatoes.",
    ],
    stepsAr: [
      "اطبخي الكينوا أو الأرز حسب تعليمات العبوة.",
      "اشوي البروكلي والفلفل الحلو والكوسا مع زيت الزيتون حتى تنضج.",
      "قطّعي صدر الدجاج المشوي شرائح.",
      "رتّبي الطبق بالحبوب والخضروات المشوية والدجاج والطماطم الكرزية المقطعة.",
    ],
  },
  {
    ...
    produce: ["Strawberry", "Blueberries", "Banana"],
    pantry: ["Greek yogurt", "Protein powder", "Rolled oats", "Honey"],
    pantryAr: ["لبن يوناني", "بروتين بودرة", "شوفان", "عسل"],
    steps: [
      "Mix the Greek yogurt with a scoop of protein powder until smooth.",
      "Slice the banana and strawberries.",
      "Layer the yogurt mixture in a bowl with the sliced fruit and blueberries.",
      "Top with a sprinkle of oats and a drizzle of honey.",
    ],
    stepsAr: [
      "اخلطي اللبن اليوناني مع ملعقة من البروتين بودرة حتى يصبح القوام ناعمًا.",
      "قطّعي الموز والفراولة شرائح.",
      "رتّبي خليط اللبن في طبق مع الفواكه المقطعة والتوت الأزرق.",
      "زيّنيه برشة من الشوفان ورشة من العسل.",
    ],
  },
];
...
function AppShell() {
  ...
  // Lets Google Play (and anyone else) link straight to the privacy policy
  // at daroushafresh.com/?privacy=1 without loading the whole app first —
  // required since app store listings need a directly-loadable URL, not a
  // page only reachable by clicking a footer link after the app boots.
  function getPrivacyParam() {
    try {
      return new URLSearchParams(window.location.search).get("privacy");
    } catch {
      return null;
    }
  }
  function getDeleteAccountParam() {
    try {
      return new URLSearchParams(window.location.search).get("delete-account");
    } catch {
      return null;
    }
  }
...
function AiRecipeBuilderView({ setView, products, addToCart, logAiRecipeRequest, markAiRecipeRequestConverted }) {
  ...
  const [error, setError] = useState(null);
  // Unified shape regardless of source:
  // { source: "ai" | "local", recipeName, recipeNameAr, tagline, taglineAr,
  //   baseServings, required: [{name, quantity, unit}], optional: [...],
  //   pantry, pantryAr }
  ...
  async function submit(text) {
    ...
    // Try the AI first — handles genuinely arbitrary free text.
    try {
      ...
      const data = await res.json();
      if (res.ok && !data.error && data.recipe_name && Array.isArray(data.required) && data.required.length > 0) {
        setResult({
          source: "ai",
      ...
      if (res.ok && data.error && data.error !== undefined && !data.recipe_name) {
        // AI reached fine but said "tell us more" — that's a real answer, not
        // a failure, so don't fall back silently; show it directly.
        setError(data.error);
        setLoading(false);
        return;
      }
    } catch {
      // network/API failure — fall through to local matching below
    }

    // Fallback: match against the local, always-available recipe library.
    const match = matchRecipeFromQuery(q);
    if (!match) {
      setError(
        isAr
          ? "لم نتمكن من إنشاء هذه الوصفة. جرّب أحد أطباقنا مثل \"فتوش\" أو \"ملوخية\" أو \"شكشوكة\"."
          : "Sorry, we couldn't build that recipe. Try one of our dishes like \"Fattoush\", \"Molokhia\", or \"Shakshuka\"."
      );
      setLoading(false);
      return;
    }
    ...
    setResult({
      ...
      recipeNameAr: match.nameAr,
      tagline: match.tagline,
      taglineAr: match.taglineAr,
      baseServings: s,
      required: match.produce.map((name) => ({ name, quantity: null, unit: null })),
      optional: [],
      pantry: match.pantry,
      pantryAr: match.pantryAr,
    });
    setServings(s);
    setLoading(false);
  }
  ...
  function scaledQuantity(ing) {
    if (result.source !== "ai" || !servings || !result.baseServings) return ing.quantity;
    return ing.quantity * (servings / result.baseServings);
  }
  ...
  function buildMatches(list, group) {
    const raw = (list || []).map((ing) => {
      ...
      let conv = null;
      if (product) {
        conv = result.source === "ai"
          ? convertIngredientToProductQty({ ...ing, quantity: scaledQuantity(ing) }, product)
          : estimateRecipeIngredientQty(product, servings);
      }
  ...
  function addAllAvailable() {
    allAvailable.forEach((m) => {
      ...
      addToCart({
        ...
        source: "ai_recipe", recipeName: result.recipeName, recipeServings: servings,
      });
    });
    ...
    <div style={{ paddingTop: 22, maxWidth: 640, margin: "0 auto" }}>
      ...
      {result && (
        <div style={{ marginTop: 26 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <div>
              <div style={{ fontFamily: "Fraunces, serif", fontWeight: 800, fontSize: 22 }}>
                {result.source === "local" && isAr ? result.recipeNameAr : result.recipeName}
              </div>
              <div style={{ fontSize: 13, opacity: 0.65, marginTop: 2 }}>
                {result.source === "local"
                  ? (isAr ? result.taglineAr : result.tagline)
          ...
          {result.source === "local" && result.pantry && result.pantry.length > 0 && (
            <div style={{ marginTop: 20 }}>
              <div style={{ fontSize: 11.5, fontWeight: 800, letterSpacing: "0.05em", textTransform: isAr ? "none" : "uppercase", opacity: 0.5, marginBottom: 10 }}>
                {isAr ? "من مطبخك أيضًا (غير مُباع لدينا)" : "You'll Also Need (not sold here)"}
              </div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {(isAr ? result.pantryAr : result.pantry).map((item, i) => (
...
// A directly-loadable page (daroushafresh.com/?delete-account=1) required
// by Google Play whenever an app lets users create accounts — it needs an
// account-deletion path that's reachable without opening the app first.
// There's no self-service delete button in the app yet, so this documents
// the request-by-contact process clearly, which Google's policy accepts
// as long as the steps and data handling are spelled out plainly.
function DeleteAccountView({ setView }) {
  const { lang } = useLang();
  const isAr = lang === "ar";
  return (
    <div style={{ paddingTop: 40, maxWidth: 720, margin: "0 auto" }}>
      ...
      <h2 style={{ fontFamily: "Fraunces, serif", marginTop: 8, textAlign: "center" }}>{isAr ? "حذف الحساب والبيانات" : "Delete Your Account & Data"}</h2>
      <p style={{ textAlign: "center", fontSize: 12, opacity: 0.6, marginBottom: 12 }}>{isAr ? "Darousha Fresh" : "Darousha Fresh"}</p>
      <div style={{ textAlign: isAr ? "right" : "left", background: "#fff", border: `1px solid ${BRAND.creamDeep}`, borderRadius: 14, padding: 24, fontSize: 13.5, lineHeight: 1.75, opacity: 0.9 }}>
        {isAr ? (
          <>
            <p>يمكنك طلب حذف حسابك في Darousha Fresh وبياناتك المرتبطة به في أي وقت.</p>
            <p><b>خطوات الطلب:</b></p>
            <ol style={{ paddingInlineStart: 20, margin: "8px 0" }}>
              <li>تواصل معنا عبر واتساب على {formatPhoneDisplay(WHATSAPP_NUMBER)} أو عبر البريد الإلكتروني {BUSINESS_EMAIL}.</li>
              <li>اذكر البريد الإلكتروني المسجّل في حسابك، واطلب صراحةً حذف حسابك وبياناتك.</li>
              <li>سنؤكد هويتك ونعالج طلبك خلال ٧ أيام عمل كحد أقصى.</li>
            </ol>
            <p><b>ما الذي يُحذف:</b> اسمك، بريدك الإلكتروني، رقم هاتفك، عناوين التوصيل المحفوظة، نقاط الولاء، وأي صور أو نصوص قدّمتها في التقييمات.</p>
            <p><b>ما الذي قد نحتفظ به:</b> سجلات الطلبات المكتملة قد يتم الاحتفاظ بها لفترة إضافية للأغراض المحاسبية والقانونية، بشكل منفصل عن حسابك الشخصي المحذوف.</p>
          </>
        ) : (
          <>
            <p>You can request deletion of your Darousha Fresh account and its associated data at any time.</p>
            <p><b>Steps to request deletion:</b></p>
            <ol style={{ paddingInlineStart: 20, margin: "8px 0" }}>
              <li>Contact us via WhatsApp at {formatPhoneDisplay(WHATSAPP_NUMBER)} or by email at {BUSINESS_EMAIL}.</li>
              <li>Include the email address your account is registered under, and clearly state you'd like your account and data deleted.</li>
              <li>We'll verify your identity and process the request within 7 business days.</li>
            </ol>
            <p><b>What gets deleted:</b> your name, email, phone number, saved delivery addresses, loyalty points, and any photos or text you submitted in reviews.</p>
            <p><b>What we may retain:</b> completed order records may be kept for a further period for accounting and legal purposes, separately from your deleted personal account.</p>
          </>
        )}
      </div>
      <div style={{ textAlign: "center" }}>
